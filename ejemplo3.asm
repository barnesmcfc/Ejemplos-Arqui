;Programa que recibe un numero de 32-bit y lo muestra en pantalla, puede ser negativo
...
es_negativo:
	...
	test eax,eax
	jns .no_es_negativo		;salta si ya es positivo (negativos es si empieza en 1)
	neg eax					;lo hago positivo
